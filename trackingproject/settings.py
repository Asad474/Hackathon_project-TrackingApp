"""
Django settings for trackingproject project.
...
DEBUG = False
if not DEBUG:
    CSRF_TRUSTED_ORIGINS = ['hackathonproject-trackingapp-production.up.railway.app']
...
AUTH_USER_MODEL = 'trackingapp.MyUser'
...
ROOT_URLCONF = 'trackingproject.urls'
...
WSGI_APPLICATION = 'trackingproject.wsgi.application'
